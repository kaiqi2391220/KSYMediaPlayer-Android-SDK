...
public class KSYMediaCodecInfo {
    ...
    public static KSYMediaCodecInfo setupCandidate(MediaCodecInfo codecInfo, String mimeType) {
        ...
        KSYMediaCodecInfo candidate = new KSYMediaCodecInfo();
